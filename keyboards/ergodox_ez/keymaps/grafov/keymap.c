 ...
 */
  ...
  = KEYMAP(
		   ...
		   KC_LSHIFT,XXXXX,KC_LABK,KC_TILD,KC_AT,KC_TAB,_____,
 ...
 */
  ...
  = KEYMAP(// left fingers
	   ...
	   KC_LSHIFT,KC_NO,KC_LABK,KC_TILD,KC_AT,KC_TAB,_____,
 ...
 */
  ...
  = KEYMAP(// left fingers
  		   ...
  		   _____,RCTL(KC_Z),RCTL(RSFT(KC_COMMA)),KC_PGUP,KC_PGDOWN,KC_TAB,_____,
