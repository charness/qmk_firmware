 ...
 */    
  ...
  = KEYMAP( // left fingers
	   ...
	   OSL(LAYER_WM),SFT_T(KC_M),KC_C,KC_X,KC_DOT,LT(LAYER_NUMPAD,KC_SLASH),KC_RSHIFT,
 ...
 */    
  ...
  = KEYMAP(
		   ...
		   OSL(LAYER_WM),SFT_T(KC_N),TD(TD_SHSIG),KC_COMMA,KC_DOT,LT(LAYER_NUMPAD,KC_QUOTE),KC_RSHIFT,
