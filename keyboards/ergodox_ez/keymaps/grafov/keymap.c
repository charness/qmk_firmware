 ...
 */
  [LAYER_KEYMACS] \
  = KEYMAP( // left fingers
		   KC_ESCAPE,KC_GRAVE,KC_COLON,KC_MINUS,KC_EXLM,KC_PLUS,KC_DELETE,
		   KC_LALT,KC_Q,KC_B,KC_P,KC_F,ALGR_T(KC_G),OSL(LAYER_FN),
		   KC_LCTL,LT(LAYER_NUMPAD,KC_R),KC_A,KC_E,LT(LAYER_AUXCHARS,KC_N),RCTL_T(KC_S),
		   KC_LSHIFT,LT(LAYER_AUXCHARS,KC_Z),KC_COMMA,KC_U,KC_K,LT(LAYER_CONTROL,KC_J),M(M_EMACS_SELECT),
		   ...
		   CTL_T(KC_D),LT(LAYER_AUXCHARS,KC_O),KC_T,KC_I,LT(LAYER_NUMPAD,KC_H),KC_RCTL,
		   OSL(LAYER_WM),LT(LAYER_CONTROL,KC_M),KC_C,KC_X,KC_DOT,LT(LAYER_AUXCHARS,KC_SLASH),KC_RSHIFT,
 ...
 */    
  ...
  = KEYMAP(
		   ...
		   KC_LCTL,LT(LAYER_NUMPAD,KC_A),KC_S,KC_D,LT(LAYER_AUXCHARS_RU,KC_F),RCTL_T(KC_G),
		   KC_LSHIFT,LT(LAYER_AUXCHARS_RU,KC_Z),KC_6,KC_C,KC_V,LT(LAYER_CONTROL,KC_B),_____,
		   ...
		   LCTL_T(KC_H),LT(LAYER_AUXCHARS_RU,KC_J),KC_K,KC_L,LT(LAYER_NUMPAD,KC_SCOLON),KC_RCTL,
		   OSL(LAYER_WM),LT(LAYER_CONTROL,KC_N),TD(TD_SHSIG),KC_COMMA,KC_7,LT(LAYER_AUXCHARS_RU,KC_QUOTE),KC_RSHIFT,
